...
class Main():
    ...
    def init_buttons_frame(self):
        ...
        self.download_data_button = Button(self.buttons_frame, anchor=tkinter.W, text="Download\nData", takefocus=False,
                                           padx=BUTTON_PAD_X+25, pady=BUTTON_PAD_Y, font=(FONT_SIZE-10, BUTTON_SIZE-10), command=lambda: self.out_q.put("send_download_data()"))

        self.calibrate_depth_button = Button(self.buttons_frame, anchor=tkinter.W, text="Calibrate\nDepth", takefocus=False,
                                             padx=BUTTON_PAD_X+30, pady=BUTTON_PAD_Y, font=(FONT_SIZE-10, BUTTON_SIZE-10), command=lambda: self.out_q.put("send_calibrate_depth()"))

        self.calibrate_imu_heading_button = Button(self.buttons_frame, anchor=tkinter.W, text="Calibrate\nHeading\nOrientation", takefocus=False,
                                             padx=BUTTON_PAD_X+35, pady=BUTTON_PAD_Y, font=(FONT_SIZE-10, BUTTON_SIZE-10), command=lambda: self.out_q.put("send_calibrate_heading()"))
